...
public class BaseDao {
    private static String tNamelogin = "admin";
    private static String tNameStu = "normal";
    ...
    public String getNormalPwd(String id){
        String sql = "select password from " + tNameStu + " where id = ?";
        String pwd = "";
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1, id);
    ...
    public boolean add(Man man) {
        ...
        int result = 0;
        String sql="insert into " + tNameStu + " values(?,?,?,?,?,?,NULL)";
    ...
    public boolean setHash(String id, String hashCode){
        int result = 0;
        String sql="update normal " + tNameStu + " set hashCode = ? where id = ?";
    ...
    public Map<Man, String> getAllHashCode(){
        Map<Man, String> res = new HashMap<>();
        String sql = "SELECT id, name, tel, qq, mail, hashCode FROM " + tNameStu;
        ...
        try {
            ...
            while(rs.next()) {
                ...
                String qq = rs.getString(4);
                String mail = rs.getString(5);
                String hashCode = rs.getString(6);

                Man man = new Man(id, name, tel, qq, mail);
                res.put(man, hashCode);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
