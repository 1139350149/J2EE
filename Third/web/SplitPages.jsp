...
<%@ page import="Third.UnderGraduate" %>
...
<div class="container">
    ...
    <%
        if ("admin".equals(from)){
            out.println("<a href = \"admin.jsp\">返回管理员页</a>");
        }
    %>
    ...
    <table>
        ...
        <tbody>
        <%
            for (int i = 0; i < underGraduateArrayList.size(); i++) {
                out.println("<tr>");
    ...
    <%
        if (currentPage <= 1) {
            ...
            out.println("<a href=\"SearchServlet?currentPage=" + (currentPage - 1) + "\">上一页</a>");
            out.println(currentPage + " / " + totalPageCount + " 页");
        }
        if (currentPage < totalPageCount) {
            out.println("<a href=\"SearchServlet?currentPage=" + (currentPage + 1) + "\">下一页</a>");
        }
        out.println("<a href=\"SearchServlet?currentPage=" + totalPageCount + "\">尾页</a>");
    %>
